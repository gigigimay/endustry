...
class SearchItems {
  ...
  static Widget searchItemNews(ImageProvider img, News data, size) {
    return Container(
        color: Colors.white,
        padding: const EdgeInsets.symmetric(
  ...
  static Widget searchItemService(ImageProvider img, Service data, size) {
    return Container(
        color: Colors.white,
        padding: const EdgeInsets.symmetric(
            vertical: CONSTANT.SIZE_SM, horizontal: CONSTANT.SIZE_XL),
  ...
  static Widget searchItemKnowledge(ImageProvider img, Knowledge data) {
    return Container(
